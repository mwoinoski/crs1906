...
class AllNewsFeedReader:
    ...
    def get_news(self, max_items=0):
        ...
        # music_news = self.feed_reader.get_news('music', max_items)
        # sports_news = self.feed_reader.get_news('sports', max_items)
        # movie_news = self.feed_reader.get_news('movies', max_items)
