...
class VenueDaoTest(TestCase):
    ...
    def test_get_venue_found(self):
        ...
        self.assertEqual('E Congress Pkwy, Chicago, IL 60605', venue.street_address)
    ...
    def test_get_venue_by_name_found(self):
        venue = self.venue_dao.get_venue_by_name('Auditorium Theatre', self.session)
    ...
    def test_get_venue_not_found(self):
        self.assertRaises(PersistenceError, self.venue_dao.delete, 999, self.session)
    ...
    def test_update_venue_ok(self):
        venue = Venue(id=678, city='London', country='United Kingdom', latitude=51.5072,
                      longitude=-0.1275, name='Royal Albert Hall',
                      street_address='Kensington Gore, London SW7 2AP')
