...
ticketmanor_controllers.controller('newsCtrl',['$scope', '$rootScope', '$state', 
  '$stateParams', '$timeout', 'concerts', 'sports', 'movies', 'news',
  function($scope, $rootScope, $state, $stateParams, $timeout, concerts, 
    sports, movies, news) {
  var _scope = {};
  _scope.init = function() {
    ...
    if($scope.event_type) {
      ...
      $scope.news = news.model.get();
      news.list.get($scope.news);
    }
  }  
  _scope.init();
}]);